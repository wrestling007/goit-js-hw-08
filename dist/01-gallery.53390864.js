...
galleryRef.insertAdjacentHTML("afterbegin", greateMarcup((0, _galleryItems.galleryItems)));
...
function imageOpenClose(evt1) {
    const instance = basicLightbox.create(`
	<img class= "original-img" src = '${evt1.target.dataset.source}' width = '1280'>`, {
